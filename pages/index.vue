...
const {
  ...
  incomeTotal,
  expenseTotal,
  transactions: { grouped: byDate },
} = useFetchTransactions();

// Initially fetch the transactions.
await refresh();

// Dummy previous totals (replace with your actual logic if available)
const prevIncomeTotal = computed(() => 0);
const prevExpenseTotal = computed(() => 0);
</script>
